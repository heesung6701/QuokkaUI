...
class ComponentPickerCustomTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityComponentPickerCustomTestBinding.inflate(layoutInflater)
        ...
        CoroutineScope(Dispatchers.Main).launch {
            mutableStateFlow.collect { uiState ->
                ...
                val appInfoList = AppInfoHelper
                    .getInstalledPackages(this@ComponentPickerCustomTestActivity.packageManager)
